...
def process_csv_file(path, attack_id):
    ...
    # 4. [추가] DLC 타입 변환 (Numba 호환성을 위해 int64 권장)
    df["DLC"] = df["DLC"].astype(np.int64)
...
def Make_feature(path, attack_id):
    ...
    # ======== calculate feature ========== #
    feature9 = calculate_features_numba(timestamps, can_ids, dlcs, payloads)
...
# ==========================================
np.savez(
    "C:/Users/user/Desktop/IDS_masters/dataset/carhacking_test_0204_2차.npz",
